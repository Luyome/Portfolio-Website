...
- Task 2.5 — Permanent Browser QA Harness: **Next.** Small, reusable responsive Admin QA command. Scope: 390, 768, and 1440 viewports; horizontal-overflow checks; console/runtime-error checks; a dependency-free Chrome/CDP approach; no temporary Puppeteer or Playwright install; only ever closes the browser process it launched itself; no full visual-regression system.
...
- Task 2.6 — Admin Authentication & Destructive Action Safety: Planned.
