...
- Task 2.6 — Admin Authentication & Destructive Action Safety: **Planned.** Owner-only Admin mutation security. Scope: server-action session checks; defense-in-depth alongside proxy protection; invalid-session behaviour; safe redirect; delete and irreversible-action protection. No public user, OAuth, multi-admin, or role system.
- Task 2.7 — Media Upload Safety: **Planned.** Scope: file type and size limits; upload status and error feedback; preview; blocking unsupported source/master files; basic Blob security. No full media library or advanced asset manager.
- Task 2.8 — Existing CRUD Consistency: **Planned.** Scope: create/edit/delete consistency; redirect; invalid-ID and not-found behaviour; empty states; deterministic ordering; double-submit protection; save/error feedback.
- Task 2.9 — Controlled Metadata Foundation & Manager: **Planned.** Medium, Subject Matter, Software, and Tags only. Scope: minimal taxonomy data model; Admin Metadata Manager; name, slug, sort order, and active/inactive; Software logo/icon; safe management of options already in use. No universal CMS for all future content types.
- Task 2.10 — Portfolio Metadata Selectors & Legacy Migration: **Planned.** Scope: controlled metadata selectors in the Portfolio form; searchable multi-select; selected chips; safe migration of existing Medium, Software, and Tags data; add Subject Matter. Legacy columns are not removed before the migrated data is verified.
- Task 2.11 — Admin Integration QA: **Planned.** Test the Admin shell, Dashboard, shared form system, authentication, upload, CRUD, Metadata Manager, and Portfolio selectors together. Scope: responsive; accessibility; type-check; lint; build.
- Task 2.12 — Sprint 2 Close: **Planned.** Once Task 2.1–2.11 are complete, close Sprint 2 and mark Sprint 3 as the next sprint.
...
- Task 2.6 — Admin Authentication & Destructive Action Safety: Next.
- Task 2.7 — Media Upload Safety: Planned.
- Task 2.8 — Existing CRUD Consistency: Planned.
- Task 2.9 — Controlled Metadata Foundation & Manager: Planned.
- Task 2.10 — Portfolio Metadata Selectors & Legacy Migration: Planned.
- Task 2.11 — Admin Integration QA: Planned.
- Task 2.12 — Sprint 2 Close: Planned.
...
- No new sprint will be added until Sprint 10 is complete.
